...
class Receptor_OneSeg(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.low_pass_filter_0, 0), (self.SYNC_DEM_OFDM_1SEG_0, 0))    
    ...
    def set_total_carriers(self, total_carriers):
        ...
        self.SYNC_DEM_OFDM_1SEG_0.set_carriers(self.total_carriers)
    ...
    def set_guard(self, guard):
        self.guard = guard
        self._guard_callback(self.guard)
        self.SYNC_DEM_OFDM_1SEG_0.set_guarda(self.guard)
